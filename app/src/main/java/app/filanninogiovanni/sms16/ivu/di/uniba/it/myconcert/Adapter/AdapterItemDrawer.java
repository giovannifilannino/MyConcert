 ...
 */
public class AdapterItemDrawer extends RecyclerView.Adapter<AdapterItemDrawer.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView,int ViewType,Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                textView = (TextView) itemView.findViewById(R.id.scelta); // Creating TextView object with the id of textView from item_row.xml
    ...
    @Override
    public AdapterItemDrawer.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_scelte_drawer,parent,false); //Inflating the layout
    ...
    @Override
    public void onBindViewHolder(AdapterItemDrawer.ViewHolder holder, int position) {
